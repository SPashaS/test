(() => {
  ...
  const l = document.querySelector(".burger"),
    ...
    d = document.querySelector(".search-menu__form");
  function u(e) {
    setTimeout(() => {
  ...
  new ye("max").init(),
    ...
    (xe = function () {
      ...
      var K = {
        ...
        ze = function (e) {
          return (
            $e[e] || ($e[e] = (_e && Pe[e]) || (_e ? Pe : R)("Symbol." + e))
          );
        },
        Ie = ze("species"),
        We = function (e, t) {
    ...
    (window.onload = function () {
      document.addEventListener("click", function (e) {
        ...
        const i = document.querySelector(".button-contacts-header"),
          n = document.querySelector(".contacts");
          ...
          console.log(l),
            ...
            window.innerWidth < 767.98 &&
              ...
              document.querySelector(".menu-open") &&
                ...
                console.log("закрыть")));
        } else ((!t.closest(".contacts") && document.querySelectorAll(".contacts-open")) || t.closest(".call-back")) && (document.documentElement.classList.remove("contacts-open"), o());
      });
    }),
