      ...
      732: function (e) {
        e.exports = (function () {
          ...
          var t = "undefined" != typeof window,
            ...
            N = function (e, t) {
              var n = e.parentNode;
              n && "PICTURE" === n.tagName && W(n).forEach(t);
            },
            B = function (e, t) {
              W(e).forEach(t);
            },
            ...
            Y = function (e, t, n) {
              A(e, t.class_loading),
                C(e, m),
                n && (z(n, 1), k(t.callback_loading, e, n));
            },
            U = function (e, t, n) {
  ...
  (() => {
    ...
    function f(e = {}, t = {}) {
      Object.keys(t).forEach((n) => {
        void 0 === e[n]
          ? (e[n] = t[n])
          : h(t[n]) && h(e[n]) && Object.keys(t[n]).length > 0 && f(e[n], t[n]);
      });
    }
    const m = {
      body: {},
    ...
    const T = {
      ...
      on: function (...e) {
        ...
        function r(e) {
          ...
          if ((s.indexOf(e) < 0 && s.unshift(e), x(t).is(n))) i.apply(t, s);
          else {
            const e = x(t).parents();
            for (let t = 0; t < e.length; t += 1)
              x(e[t]).is(n) && i.apply(e[t], s);
          }
        }
        function o(e) {
      ...
      is: function (e) {
        ...
        if ("string" == typeof e) {
          ...
          for (s = x(e), r = 0; r < s.length; r += 1) if (s[r] === i) return !0;
          return !1;
        }
        if (e === n) return i === n;
        if (e === t) return i === t;
      ...
      nextAll: function (e) {
        ...
        for (; n.nextElementSibling; ) {
          ...
          e ? x(i).is(e) && t.push(i) : t.push(i), (n = i);
        }
        return x(t);
      },
      prev: function (e) {
      ...
      parent: function (e) {
        ...
        for (let n = 0; n < this.length; n += 1)
          null !== this[n].parentNode &&
            (e
              ? x(this[n].parentNode).is(e) && t.push(this[n].parentNode)
        ...
        if (
          ...
          if (0 === t) a[e ? "scrollLeft" : "scrollTop"] = -d;
            ...
            if (!r.support.smoothScroll)
              return (
                z({ swiper: r, targetPosition: -d, side: e ? "left" : "top" }),
                !0
              );
    ...
    const F = {
      slideTo: function (e, t, n, i, s) {
        ...
        if (a.cssMode) {
          ...
          if (0 === t) {
            ...
            if (!r.support.smoothScroll)
              return (
                z({ swiper: r, targetPosition: n, side: e ? "left" : "top" }),
                !0
              );
      ...
      slideToClickedSlide: function () {
        ...
        if (t.loop) {
          ...
          (s = parseInt(O(e.clickedSlide).attr("data-swiper-slide-index"), 10)),
            t.centeredSlides
    ...
    const V = {
      loopCreate: function () {
        const e = this,
          ...
          s = i.children().length > 0 ? O(i.children()[0].parentNode) : i;
        ...
        for (let e = 0; e < a.length; e += 1)
          s.append(O(a[e].cloneNode(!0)).addClass(n.slideDuplicateClass));
        for (let e = o.length - 1; e >= 0; e -= 1)
          s.prepend(O(o[e].cloneNode(!0)).addClass(n.slideDuplicateClass));
      },
      loopFix: function () {
        const e = this;
    ...
    function X(e) {
      ...
      if (
        ...
        c.is(s.focusableElements) &&
          ...
          n.activeElement &&
            O(n.activeElement).is(s.focusableElements) &&
            n.activeElement !== c[0] &&
    ...
    function Y(e) {
      ...
      if (!n.allowTouchMove)
        return (
          O(l.target).is(i.focusableElements) || (n.allowClick = !1),
          void (
            i.isTouched &&
            (Object.assign(r, {
              startX: d,
      ...
      n({
        ...
        i("click", (e, n) => {
          const { $nextEl: i, $prevEl: r } = t.navigation,
            o = n.target;
          if (t.params.navigation.hideOnClick && !O(o).is(r) && !O(o).is(i)) {
            if (
              t.pagination &&
              t.params.pagination &&
    ...
    function me(e) {
      ...
      function d() {
        ...
        if (
          ("fraction" === n.type &&
            (r.find(fe(n.currentClass)).text(n.formatFractionCurrent(d + 1)),
            r.find(fe(n.totalClass)).text(n.formatFractionTotal(u))),
          "progressbar" === n.type)
        ) {
          let e;
          ...
          "horizontal" === e ? (s = i) : (o = i),
            r
              .find(fe(n.progressbarFillClass))
      ...
      function p() {
        ...
        0 !== n.length &&
          (t.params.uniqueNavElements &&
            ...
            ((n = t.$el.find(e.el)),
            n.length > 1 &&
              (n = n.filter((e) => O(e).parents(".swiper")[0] === t.el))),
          ...
          e.clickable &&
            n.on("click", fe(e.bulletClass), function (e) {
              e.preventDefault();
              let n = O(this).index() * t.params.slidesPerGroup;
      ...
      function h() {
        ...
        n.removeClass(e.hiddenClass),
          ...
          e.clickable && n.off("click", fe(e.bulletClass));
      }
      i("init", () => {
        p(), u(), d();
      }),
    ...
    setTimeout(() => {
      ...
      (be.prototype.moveTo = function (e, t, n) {
      ...
      (be.prototype.moveBack = function (e, t, n) {
    ...
    function Ee() {
      try {
        ...
        if ("dark" === localStorage.getItem("theme")) {
          if ((document.querySelector("html").classList.add("dark"), e)) {
    ...
    new be("max").init(),
      ...
      (we = function () {
        ...
        var n,
          ...
          N = a.WeakMap,
          B = "function" == typeof N && /native code/.test(W.call(N)),
          D = 0,
          R = Math.random(),
          j = function (e) {
            return (
        ...
        var K = {
          ...
          ve = function (e, t) {
            for (var n = ge(t), i = P.f, s = k.f, r = 0; r < n.length; r++) {
              var o = n[r];
              S(e, o) || i(e, o, s(t, o));
            }
          },
        ...
        var gt = { IteratorPrototype: rt, BUGGY_SAFARI_ITERATORS: mt },
          vt = P.f,
          bt = ze("toStringTag"),
          yt = function (e, t, n) {
            e &&
              !S((e = n ? e : e.prototype), bt) &&
              vt(e, bt, { configurable: !0, value: t });
          },
          wt = gt.IteratorPrototype,
          Et = function () {
            return this;
          },
          xt =
            ...
            ("__proto__" in {}
              ...
              : void 0),
          St = gt.IteratorPrototype,
          Ct = gt.BUGGY_SAFARI_ITERATORS,
          Tt = ze("iterator"),
          Ot = function () {
            return this;
          },
        ...
        var Nt =
            "[object z]" !== String(Wt)
              ...
              : Wt.toString,
          Bt = Object.prototype;
        Nt !== Bt.toString && J(Bt, "toString", Nt, { unsafe: !0 });
        var Dt = "\t\n\v\f\r                　\u2028\u2029\ufeff",
          Rt = "[" + Dt + "]",
          jt = RegExp("^" + Rt + Rt + "*"),
          qt = RegExp(Rt + Rt + "*$"),
        ...
        var Mn = "Expected a function",
          ...
          In = /^0o[0-7]+$/i,
          Wn = parseInt,
          Nn = "object" == typeof e && e && e.Object === Object && e,
          Bn =
            "object" == typeof self && self && self.Object === Object && self,
          Dn = Nn || Bn || Function("return this")(),
                        ...
                        return (
                          Ii.some(function (e) {
                            ...
                            ("function" == typeof ErrorEvent
                              ? (e = new ErrorEvent("error", { message: Wi }))
        ...
        Ws("replace", 2, function (e, t, n) {
          return [
            ...
            function (e, s) {
              ...
              for (var h, f = "", m = 0, g = 0; g < u.length; g++) {
                p = u[g];
                for (
                  var v = String(p[0]),
                ...
                var E = p.groups;
                if (l) {
                  var x = [v].concat(y, b, a);
                  void 0 !== E && x.push(E);
                  var S = String(s.apply(void 0, x));
                } else S = i(v, a, b, y, E, s);
                b >= m && ((f += a.slice(m, b) + S), (m = b + v.length));
              }
              return f + a.slice(m);
            },
          ];
      ...
      (function () {
        if (window.innerWidth > 1023.98) {
          ...
          const t = document.querySelector(".menu__list").children,
            n = document.querySelector(".menu").offsetWidth,
            i = document.querySelector(".menu__body");
          let s = 75;
          t.forEach(function (t, i, r) {
            let o = t.clientWidth;
            console.log(`ширина айтема ${o}`),
              (s += o),
              window.innerWidth > 1023.98 && window.innerWidth < 1365.98
                ? ((s += 12), console.log(`margin - 12 ---${s}`))
                : window.innerWidth > 1365.98 && window.innerWidth < 1919.98
                ? ((s += 16), console.log(`margin - 16 ---${s}`))
                : window.innerWidth > 1919.98 &&
                  ((s += 29), console.log(`margin - 29 ---${s}`)),
              console.log(`лево ${s}`),
              n < s && (console.log("скрыть"), e.push(t));
          }),
            console.log(`${n} ширина меню < ${s} айтем`),
            n < s &&
    ...
    function Se(e = null) {
      ...
      document.querySelectorAll(".menu__sub-list").forEach((n) => {
        n == e ||
          t.includes(n) ||
    ...
    xe &&
      xe.addEventListener("click", function (e) {
        Se(), document.documentElement.classList.toggle("menu-more");
      }),
          ...
          if (n.contains(e.target) || i.contains(e.target)) {
            ...
            console.log(o),
              window.innerWidth > 767.98 && window.innerWidth < 1023.98
                ? ((s.style.top = i + 20 + "px"), (s.style.right = r + "px"))
                : window.innerWidth > 1023.98 &&
                  ((s.style.top = i + 35 + "px"), (s.style.right = r + "px")),
      ...
      document.querySelector(".menu__body").addEventListener("click", (e) => {
        ...
        t.classList.contains("menu__button-sub-open") &&
          n &&
          i &&
          (Se(i), i.classList.toggle("_open"), n.classList.toggle("_hover")),
          t.classList.contains("menu__sub-list-back") &&
            !t.closest("menu__item") &&
            t.parentNode.classList.remove("_open");
      }),
      (document.querySelector(".menu").onmouseleave = Se),
      (function () {
        const e = document.documentElement.clientWidth;
        document
    ...
    var Ce = document.querySelectorAll(".language-header__item");
    for (var Te of Ce)
    ...
    const Oe = document.querySelector(".burger"),
      _e = document.querySelector(".menu__list"),
      Le = document.querySelector(".search-menu__form");
    document.addEventListener("click", function (e) {
      const t = e.target,
        n = t == Oe || Oe.contains(t),
        i = t == _e || _e.contains(t),
          ...
          function a(e) {
            ...
            if (t.closest("[data-spoller]")) {
              ...
              i.querySelectorAll("._slide").length ||
                (o && !n.classList.contains("_spoller-active") && l(i),
