(() => {
  ...
  const l = document.querySelector(".burger"),
    ...
    c = document.querySelector(".search-menu__form");
  function p(e) {
    setTimeout(() => {
  ...
  function Se(e = null) {
    ...
    const s = document.querySelectorAll(".menu__sub-list");
  ...
  new be("max").init(),
    ...
    (window.onload = function () {
      document.addEventListener("click", function (e) {
        ...
        const s = document.querySelector(".button-contacts-header"),
          i = document.querySelector(".contacts");
        if (s.contains(e.target)) {
          const e = document.documentElement.clientWidth,
            t = s.getBoundingClientRect().right,
            o = s.getBoundingClientRect().bottom,
            l = e - t;
          console.log(l),
            console.log(o),
            console.log(n),
    ...
    document.querySelectorAll(".menu__sub-list").forEach(function (e, t, s) {
      e &&
