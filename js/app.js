(() => {
  ...
  const E = {
    ...
    on: function (...e) {
      ...
      function r(e) {
        ...
        if ((s.indexOf(e) < 0 && s.unshift(e), y(t).is(i))) n.apply(t, s);
        else {
          const e = y(t).parents();
          for (let t = 0; t < e.length; t += 1)
            y(e[t]).is(i) && n.apply(e[t], s);
        }
      }
      function o(e) {
    ...
    is: function (e) {
      ...
      if ("string" == typeof e) {
        ...
        for (s = y(e), r = 0; r < s.length; r += 1) if (s[r] === n) return !0;
        return !1;
      }
      if (e === i) return n === i;
      if (e === t) return n === t;
    ...
    parents: function (e) {
      ...
      for (let i = 0; i < this.length; i += 1) {
        ...
        for (; n; ) e ? y(n).is(e) && t.push(n) : t.push(n), (n = n.parentNode);
      }
      return y(t);
    },
    closest: function (e) {
      ...
      if (
        ...
        if (0 === t) a[e ? "scrollLeft" : "scrollTop"] = -d;
          ...
          if (!r.support.smoothScroll)
            return (
              _({ swiper: r, targetPosition: -d, side: e ? "left" : "top" }), !0
            );
  ...
  const q = {
    slideTo: function (e, t, i, n, s) {
      ...
      if (a.cssMode) {
        ...
        if (0 === t) {
          ...
          if (!r.support.smoothScroll)
            return (
              _({ swiper: r, targetPosition: i, side: e ? "left" : "top" }), !0
            );
    ...
    slideToClickedSlide: function () {
      ...
      if (t.loop) {
        ...
        (s = parseInt(S(e.clickedSlide).attr("data-swiper-slide-index"), 10)),
          t.centeredSlides
  ...
  function pe(e) {
    ...
    function d() {
      ...
      if (
        ("fraction" === i.type &&
          (r.find(ue(i.currentClass)).text(i.formatFractionCurrent(d + 1)),
          r.find(ue(i.totalClass)).text(i.formatFractionTotal(u))),
        "progressbar" === i.type)
      ) {
        let e;
    ...
    function u() {
      ...
      if ("bullets" === e.type) {
        ...
        n.html(r), (t.pagination.bullets = n.find(ue(e.bulletClass)));
      }
      "fraction" === e.type &&
        ((r = e.renderFraction
  ...
  setTimeout(() => {
    ...
    (fe.prototype.moveTo = function (e, t, i) {
    ...
    (fe.prototype.moveBack = function (e, t, i) {
  ...
  new fe("max").init(),
    ...
    (ve = function () {
      ...
      var i,
        ...
        W = I("native-function-to-string", Function.toString),
        B = a.WeakMap,
        N = "function" == typeof B && /native code/.test(W.call(B)),
        D = 0,
        R = Math.random(),
        j = function (e) {
          return (
      ...
      var K = {
        ...
        J = t(function (e) {
          ...
          I("inspectSource", function (e) {
            ...
            (e.exports = function (e, t, s, r) {
              ...
              return (
                ("function" == typeof this && t(this).source) || W.call(this)
              );
            });
        }),
        Z = a,
        ...
        ye = function (e, t) {
          var i = xe[we(e)];
          return i == Se || (i != Ee && ("function" == typeof t ? l(t) : !!t));
        },
        ...
        Oe = function (e, t) {
          ...
          if ((i = c ? a : d ? a[l] || z(l, {}) : (a[l] || {}).prototype))
            for (n in t) {
              if (
                ((r = t[n]),
                (s = e.noTargetGet ? (o = Te(i, n)) && o.value : i[n]),
                !Ce(c ? n : l + (d ? "." : "#") + n, e.forced) && void 0 !== s)
              ) {
        ...
        ze = function (e) {
          return (
            $e[e] || ($e[e] = (_e && Pe[e]) || (_e ? Pe : j)("Symbol." + e))
          );
        },
        Ie = ze("species"),
        We = function (e, t) {
          ...
          if (
            (g &&
              ...
              St !== Object.prototype &&
                a.next &&
                (ht(a) !== St &&
                  (Et ? Et(a, St) : "function" != typeof a[Tt] && $(a, Tt, Ot)),
                yt(a, u, !0))),
            "values" == s &&
              m &&
              "values" !== m.name &&
        ...
        Pt =
          ...
          l(function () {
            ...
            return (
              ...
              7 != _t({}, e)[i] ||
                "abcdefghijklmnopqrst" != Qe(_t({}, t)).join("")
            );
          })
            ? function (e, t) {
                for (
      ...
      var Bt =
          "[object z]" !== String(Wt)
            ...
            : Wt.toString,
        Nt = Object.prototype;
      Bt !== Nt.toString && J(Nt, "toString", Bt, { unsafe: !0 });
      var Dt = "\t\n\v\f\r                　\u2028\u2029\ufeff",
        Rt = "[" + Dt + "]",
        jt = RegExp("^" + Rt + Rt + "*"),
        qt = RegExp(Rt + Rt + "*$"),
      ...
      var Zt = function (e, t, i) {
        ...
        ri = function (e, t, i, n) {
          try {
            return n ? t(M(i)[0], i[1]) : t(i);
          } catch (t) {
            var s = e.return;
            throw (void 0 !== s && M(s.call(e)), t);
          }
        },
        oi = t(function (e) {
          var t = function (e, t) {
        ...
        Si =
          (t(function (e) {
            var t,
              ...
              o = (e.exports = pi("WeakMap", r, Ei, !0, !0));
            if (N && n) {
              (t = Ei.getConstructor(r, "WeakMap", !0)), (ti.REQUIRED = !0);
              var l = o.prototype,
                c = l.delete,
                d = l.has,
                u = l.get,
      ...
      var Mi = "Expected a function",
        ...
        zi = /^0o[0-7]+$/i,
        Ii = parseInt,
        Wi = "object" == typeof e && e && e.Object === Object && e,
        Bi = "object" == typeof self && self && self.Object === Object && self,
        Ni = Wi || Bi || Function("return this")(),
      ...
      var Fi = function (e, t, i) {
          var n = !0,
            s = !0;
          if ("function" != typeof e) throw new TypeError(Mi);
          return (
            Gi(i) &&
            ...
            (function (e, t, i) {
              ...
              return (
                ...
                Gi(i) &&
                  ((d = !!i.leading),
                  (r = (u = "maxWait" in i) ? Ri(Hi(i.maxWait) || 0, t) : r),
      ...
      function _n(e, t) {
        ...
        return (i.cache = new (_n.Cache || Ln)()), i;
      }
      function Pn(e) {
        var t = typeof e;
        return !!e && ("object" == t || "function" == t);
      ...
      (Tn.prototype.clear = function () {
        ...
        (Tn.prototype.has = function (e) {
          var t = this.__data__;
          return Cn ? void 0 !== t[e] : yn.call(t, e);
        }),
        (Tn.prototype.set = function (e, t) {
          return (this.__data__[e] = Cn && void 0 === t ? ln : t), this;
        }),
        ...
        (On.prototype.delete = function (e) {
          var t = this.__data__,
            i = kn(t, e);
          return !(
            i < 0 || (i == t.length - 1 ? t.pop() : En.call(t, i, 1), 0)
          );
        }),
      ...
      var Bn,
        ...
        Jn = function (e, t) {
          ...
          var i = getComputedStyle(e),
            n = jn(e) && e.ownerSVGElement && e.getBBox(),
            ...
            x = s ? m + g : 0,
            E = s ? v + b : 0,
            S = n ? n.width : Un(i.width) - x - w,
            C = n ? n.height : Un(i.height) - E - y,
            T = S + m + w + g,
            O = C + v + y + b,
            L = Nn({
              devicePixelContentBoxSize: Qn(
              ...
              borderBoxSize: Qn(T, O, r),
              contentBoxSize: Qn(S, C, r),
              contentRect: new Rn(u, l, S, C),
            });
          return Fn.set(e, L), L;
        },
        Zn = function (e, t, i) {
        ...
        es = function (e) {
          ...
          (this.target = e),
            ...
            (this.borderBoxSize = Nn([t.borderBoxSize])),
            (this.contentBoxSize = Nn([t.contentBoxSize])),
            (this.devicePixelContentBoxSize = Nn([
                      ...
                      return (
                        In.some(function (e) {
                          ...
                          ("function" == typeof ErrorEvent
                            ? (e = new ErrorEvent("error", { message: Wn }))
      ...
      !c ||
        ...
        ws(xs, "name", {
          ...
          get: function () {
            try {
              return Es.call(this).match(Ss)[1];
            } catch (e) {
              return "";
            }
          },
      ...
      (Ms || _s) &&
        (As = function (e) {
          var t,
            ...
            r = this;
          return (
            _s && (i = new RegExp("^" + r.source + "$(?!\\s)", Os.call(r))),
            Ms && (t = r.lastIndex),
            (n = Ls.call(r, e)),
            Ms && n && (r.lastIndex = r.global ? n.index + n[0].length : t),
            _s &&
              n &&
              n.length > 1 &&
        ...
        return [
          ...
          function (e) {
            ...
            for (var a, l = [], c = 0; null !== (a = Ds(s, r)); ) {
              var d = String(a[0]);
              (l[c] = d),
                "" === d && (s.lastIndex = Ns(r, oe(s.lastIndex), o)),
                c++;
            }
            return 0 === c ? null : l;
          },
        ...
        return [
          ...
          function (e, s) {
            ...
            for (var u = []; ; ) {
              ...
              if (null === p) break;
              if ((u.push(p), !c)) break;
              "" === String(p[0]) && (o.lastIndex = Ns(a, oe(o.lastIndex), d));
            }
            for (var h, f = "", m = 0, v = 0; v < u.length; v++) {
              ...
              var x = p.groups;
              if (l) {
                var E = [g].concat(y, b, a);
                void 0 !== x && E.push(x);
                var S = String(s.apply(void 0, E));
              } else S = n(g, a, b, y, x, s);
    ...
    "object" == typeof exports && "undefined" != typeof module
      ...
      ? define(ve)
      : ((me = me || self).SimpleBar = ve());
  const ge = document.querySelector(".menu__more-btn");
  function be(e = null) {
    let t = [];
    if (e) {
      let i = e.parentNode;
    ...
    document.querySelectorAll(".menu__sub-list").forEach((i) => {
      i == e ||
        t.includes(i) ||
  ...
  ge &&
    ge.addEventListener("click", function (e) {
      be(), document.documentElement.classList.toggle("menu-more");
    }),
      ...
      document.addEventListener("click", function (e) {
        ...
        t.classList.contains("search-menu__icon")
          ...
          : !t.closest(".form-search") &&
            ...
            document.documentElement.classList.remove("search-open"));
        const i = document.querySelector(".button-contacts-header"),
          s = document.querySelector(".contacts-block__call"),
          r = document.querySelector(".contacts");
        if (i.contains(e.target) || s.contains(e.target)) {
          const e = document.documentElement.clientWidth,
            t = i.getBoundingClientRect().right,
            s = i.getBoundingClientRect().bottom,
            o = e - t;
          console.log(n),
            window.innerWidth > 767.98 && window.innerWidth < 1023.98
              ? ((r.style.top = s + 20 + "px"), (r.style.right = o + "px"))
              : window.innerWidth > 1023.98 &&
                ((r.style.top = s + 35 + "px"), (r.style.right = o + "px")),
            document.documentElement.classList.toggle("contacts-open"),
            window.innerWidth < 767.98 &&
              document.querySelector(".menu-open") &&
              (document.documentElement.classList.remove("menu-open"),
              (document.querySelector(".menu__body").onmouseleave = be));
    ...
    document.querySelector(".menu__body").addEventListener("click", (e) => {
      ...
      t.classList.contains("menu__button-sub-open") &&
        i &&
        n &&
        (be(n), n.classList.toggle("_open"), i.classList.toggle("_hover")),
        t.classList.contains("menu__sub-list-back") &&
          !t.closest("menu__item") &&
          t.parentNode.classList.remove("_open");
    }),
    (document.querySelector(".menu").onmouseleave = be),
    (function () {
      const e = document.documentElement.clientWidth;
  ...
  var ye = document.querySelectorAll(".language-header__item");
  for (var we of ye)
  ...
  const xe = document.querySelector(".burger"),
    Ee = document.querySelector(".menu__list"),
    Se = document.querySelector(".search-menu__form");
  document.addEventListener("click", function (e) {
    const t = e.target,
      i = t == xe || xe.contains(t),
      n = t == Ee || Ee.contains(t),
      s = t == Se || Se.contains(t),
      r = document.documentElement.classList.contains("menu-open");
    n || i || s || !r || document.documentElement.classList.toggle("menu-open");
  }),
    (window.FLS = !0),
    (function (e) {
      let t = new Image();
